...
@Slf4j
public class Redeem {
	static String stringtable = "ABCDEFGHIJKLMNOPQRSTUVWXYZ23456789";
	...
	public static void main( String[] args ) throws Exception
    {
		ShowTime();
		System.out.println("=======================");
		List<String> list = create((byte)1,10,12,password);
		
		System.out.println(JSON.toJSONString(list));
 
//		VerifyCode("RKV6VDALR2BA");		
	...
	public static List<String> create(byte groupid,int codecount,int codelength,String password) {
		...
		for(int i = 0 ; i < codecount ; i ++) {
			...
			log.info("out string : " + result.toString());
			codeList.add(result.toString());//收集生成的兑换码
		}
		ShowTime();
